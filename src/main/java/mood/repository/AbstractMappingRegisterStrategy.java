 ...
 * @version: 1.0
 */
abstract class AbstractMappingRegisterStrategy implements MappingRegisterStrategy {
    ...
    public void register(Class<?> clazz, String baseUrl, Method method) {
        ...
        ControllerInfoMapping mapping = new ControllerInfoMapping();
        mapping.setUrl(url);
     ...
     * @return
     */
    abstract String getHttpMethod(Method method);
     ...
     * @param mapping
     */
    abstract void registerMapping(String url, ControllerInfoMapping mapping);
